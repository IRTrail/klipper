...
class QuadGantryLevel:
    ...
    def probe_finalize(self, offsets, positions):
        ...
        z_adjust_final = []
        for z in z_height:
            z_adjust_init.append(z_ave - z + 2)
            z_adjust_final.append(z_ave - z)

        adjust_max = max(z_adjust_final)
        ...
        self.z_helper.adjust_steppers(z_adjust_init, speed)
        self.z_helper.adjust_steppers(z_adjust_final, speed)
